...
// ActionBarB is gone. It was half of an A/B experiment ("he picks one after living with
// both") and the experiment ended in the field: A won, and B was structurally guaranteed
// to clip its highlight chips inside the 40px overflow-hidden pane header.

...
export function ClosingCard({
  ...
  return (
    <div style={{ background: "#FFFFFF", borderRadius: small ? 16 : 18, boxShadow: small ? "0 12px 40px rgba(0,0,0,0.25)" : "0 16px 48px rgba(0,0,0,0.28)", padding: small ? "15px 17px" : 18, width: small ? 430 : 420, maxWidth: "94vw", maxHeight: "86vh", overflowY: "auto", animation: "fadeUp .25s ease both" }}>
